...
titl = tk.Label(
    window, text="ATTENDANCE SYSTEM", bg="#1c1c1c", fg="yellow", font=("Verdana", 27, "bold"),
)
titl.place(x=620, y=12)
...
label2.image = a
label2.place(x=470, y=270)

vi = Image.open(os.path.join("UI_Image", "verifyy.png"))
v = ImageTk.PhotoImage(vi)
label3 = Label(window, image=v)
label3.image = v
label3.place(x=870, y=270)

vsi = Image.open(os.path.join("UI_Image", "verifyy.png"))
vs = ImageTk.PhotoImage(vsi)

label4 = Label(window, image=vs)
label4.image = vs
label4.place(x=1270, y=270)
...
students_btn.place(x=1260, y=520)
